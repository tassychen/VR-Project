...
namespace BigBlit.ActivePack.Buttons
{
    ...
    /// </summary>
    [BehaviourInfo("Basic clickable Button. Implements click and long click behaviour." +
       "Use it if you want a simple click button (not toggleable!). Works wth Press controller.")]
