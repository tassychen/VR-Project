...
namespace Obi
{
    ...
    public class ObiEmitter : ObiActor
    {
        ...
        private void CacheEmissionData()
        {
            ...
            emissionData.fluidInterface = fluidMaterial != null ? new Vector4(fluidMaterial.atmosphericDrag, fluidMaterial.atmosphericPressure, fluidMaterial.buoyancy, emitterBlueprint.miscibility) : new Vector4(0, 0, -1, emitterBlueprint != null ? emitterBlueprint.miscibility:0);
            emissionData.userData = emitterBlueprint != null ? emitterBlueprint.userData : Vector4.zero;
