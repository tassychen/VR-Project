...
namespace VRStandardAssets.ShootingGallery
{
    ...
    public class ShootingGalleryGun : MonoBehaviour
    {
        ...
        [SerializeField] private AudioSource m_GunAudio = null;                                // The audio source which plays the sound of the gun firing.
        [SerializeField]
        private ProgressbarAmmo progressbarAmmo;
        [SerializeField] private Transform m_CameraTransform = null;                           // Used as a reference to move this gameobject towards.
        [SerializeField] private Transform m_GunContainer = null;                              // This contains the gun arm needs to be moved smoothly.
        [SerializeField] private Transform m_GunEnd = null;                                    // This is where the line renderer should start from.
        [SerializeField] private LineRenderer m_GunFlare = null;                               // This is used to display the gun as a laser.
        //[SerializeField] private Reticle m_Reticle;                                     // This is what the gun arm should be aiming at.
        [SerializeField] private ParticleSystem m_FlareParticles = null;                       // This particle system plays when the gun fires.
        [SerializeField] private GameObject[] m_FlareMeshes = null;                            // These are meshes of which one is randomly activated when the gun fires.
