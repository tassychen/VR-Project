...
namespace VRStandardAssets.Utils
{
    ...
    public class UIMovement : MonoBehaviour
    {
        ...
        [SerializeField] private Transform m_UIElement = null;         // The transform of the UI to be affected.
        [SerializeField] private Transform m_Camera = null;            // The transform of the camera.
        [SerializeField] private bool m_RotateWithCamera = false;       // Whether the UI should rotate with the camera so it is always in front.
